<template>
	<view class="page container">
		<button type="primary" @click="openPopup">openPopup</button>
		...
		<view class="example-body">
			<uni-datetime-picker v-model="datetimerange" type="datetimerange" rangeSeparator="至" start="2021-3-20"
				end="2023-6-20" />
		</view>
	...
	export default {
		data() {
			return {
				...
				datetimerange: [Date.now() - 1000000000,Date.now()],
